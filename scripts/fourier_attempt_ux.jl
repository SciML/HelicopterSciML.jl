...
function helicopter_uode(dx, x, Ps, P0, u, p, t)
    ...
    #
    F_th = Ps[7]*P0.K_th_th*U[1] - Ps[8]*P0.K_th_psi*U[2] - P0.D_th*(w_th) +
           nn1([p[1]*U[1], p[2]*U[2], p[3]*th, p[4]*psi, p[5]*w_th, p[6]*w_psi], p[7:end])[1]
    F_psi = Ps[9]*P0.K_psi_th*U[1] - Ps[10]*P0.K_psi_psi*U[2] - P0.D_psi*(w_psi) +
            nn1([p[1]*U[1], p[2]*U[2], p[3]*th, p[4]*psi, p[5]*w_th, p[6]*w_psi], p[7:end])[2]
