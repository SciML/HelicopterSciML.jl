...
D_psi = 8e-2 # Nm/(rad/s)
#
P0 = (rc = rc, h = h, m = m, Jbc = Jbc, Js = Js, g = g,
    K_th_th = K_th_th, K_th_psi = K_th_psi, K_psi_th = K_psi_th,
    K_psi_psi = K_psi_psi, D_th = D_th, D_psi = D_psi)
...
plot!(title = "Experimental helicopter outputs: measured angles",
    ylabel = L"angles [$^\circ$]", xlabel = L"time $t$ [s]", box = true)
...
plot!(title = "Experimental helicopter inputs: motor voltages",
    ylabel = L"$u$ [V]", xlabel = L"time $t$ [s]", box = true)
...
Ps_keys = [
    :rc, :h, :m, :Jbc, :Js, :K_th_th, :K_th_psi, :K_psi_th, :K_psi_psi, :D_th, :D_psi]
